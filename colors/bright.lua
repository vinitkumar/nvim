...
vim.api.nvim_set_hl(0, 'NormalFloat', { fg = gui06, bg = gui01, ctermfg = cterm06, ctermbg = cterm01 })
vim.api.nvim_set_hl(0, 'FloatBorder', { fg = gui06, bg = gui01, ctermfg = cterm06, ctermbg = cterm01 })
